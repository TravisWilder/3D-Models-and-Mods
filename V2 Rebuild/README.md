# These are files used durin the rebuild of a Voron V2
...
![exhaust cover for can bus](https://github.com/TravisWilder/3D-Models-and-Mods/V2 Rebuild/images/exhaust cover for can bus.png)
